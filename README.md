...
The app provides a simple pathfinding solution implemented using modified [A*](https://en.wikipedia.org/wiki/A*_search_algorithm) algorithm, which finds a path between any two points on a map.
